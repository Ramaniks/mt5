...
input int    Signal__PeriodRSI    =33;                 // CH_HM_RSI(33,2) Period of RSI
input int    Signal__PeriodMA     =2;                  // CH_HM_RSI(33,2) Period of MA
input double Signal__Weight       =1.0;                // CH_HM_RSI(33,2) Weight [0...1.0]
//--- inputs for money
...
//--- Creating filter CH_HM_RSI
   CH_HM_RSI *filter0=new CH_HM_RSI;
   if(filter0==NULL)
     {
      //--- failed
